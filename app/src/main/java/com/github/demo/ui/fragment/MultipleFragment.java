...
import com.github.demo.ui.adapter.MultipleRecyclerAdapter;
...
public class MultipleFragment extends Fragment
{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState)
    {
        ...
        rvNormal.setAdapter(new MultipleRecyclerAdapter(getActivity()));
    }

    public static MultipleFragment getInstance(int type)
    {
